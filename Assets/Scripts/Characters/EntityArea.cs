...
public class EntityArea : AEntity
{
    ...
    private AEntity GetClosestTargetInScan(int argHitCount)
    {
    ...
    private List<AEntity> GetTargetsInRadius(Vector3 argCenterPosition, float argRadius)
    {
    ...
    private bool IsValidTarget(AEntity argTarget)
    {
