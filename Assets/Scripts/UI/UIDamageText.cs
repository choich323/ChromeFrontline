...
public class UIDamageText : MonoBehaviour
{
    ...
    [SerializeField] private float _criticalFontSizeRatio = 2f;
    ...
    public void Init(Vector2 argPos)
    {
        Clear();
        ...
        _rect.anchoredPosition = argPos + new Vector2(offsetX, offsetY);
    }
    ...
    public void PlayAnimation(float argDamage, bool argIsCritical, Team argTeam, Action<UIDamageText> argOnComplete)
    {
        ...
        seq.Append(_rect.DOAnchorPosY(_rect.anchoredPosition.y + _floatHeight, duration).SetEase(Ease.OutCubic));
